...
(function () {
  ...
  const STORAGE_KEY = "aisignal"; // main settings — owned by the options page (read-only here)
  const AI_STORE_KEY = "aisignalMarks"; // dismissals + user marks — owned by this script
